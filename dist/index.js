...
var themedStyles$2 = function themedStyles(theme) {
  ...
  return {
    ...
    extraSmall: {
      paddingRight: theme.get(unifyreReactHelper.Theme.Button.btnPadding) / 2,
      paddingLeft: theme.get(unifyreReactHelper.Theme.Button.btnPadding) / 2,
      paddingBottom: theme.get(unifyreReactHelper.Theme.Button.btnPadding) / 5,
      paddingTop: theme.get(unifyreReactHelper.Theme.Button.btnPadding) / 5,
      width: 'auto',
      alignSelf: 'center'
    },
    extraSmallText: {
...
function InputGroupAddon(_ref) {
    var _ref$placeholder = _ref.placeholder,
        ...
        props = objectWithoutProperties(_ref, ['placeholder', 'icon', 'type', 'value', 'toggleIcon', 'disabled', 'isPassword', 'onChange']);
