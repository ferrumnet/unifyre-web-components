...
export function ThemedButton({
  ...
  // position changer
  if (position === "sticky-bottom") buttonPositionStyle = styles.stickyBottom;
  else buttonPositionStyle = styles.common;
  ...
  return (
    <button
      onClick={onPress}
      disabled={disabled}
      style={{ ...bkgStyle, ...buttonPositionStyle, ...buttonSizeStyle }}
    >
